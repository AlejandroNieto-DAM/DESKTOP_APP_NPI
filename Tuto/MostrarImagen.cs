...
namespace Tuto
{
    public partial class MostrarImagen : Form
    {
        ...
        /***
         * Mostramos una imagen en base a la opcion seleccionada y cambiamos el texto y idioma segun se haya seleccionado
         */
        public MostrarImagen()
        {
            ...
            if (Language.SelectedLanguage == 1) { 
                if (optionSelected == 1)
                {
                    label1.Text = "Despachos profesores";
                ...
                if (optionSelected == 4)
                {
                    label1.Text = "Cafetería y comedor";
                ...
                if (optionSelected == 5)
                {
                    label1.Text = "Puntos de información";
                ...
                if (optionSelected == 4)
                {
                    label1.Text = "Cafeteria and dining room";
                ...
                if (optionSelected == 5)
                {
                    label1.Text = "Information locations";
           ...
           // this.label1.Margin = new Padding(this.label1.Margin.Left * ScreenWidth / FormWidth, this.label1.Margin.Top * ScreenHeight / FormHeight, this.label1.Margin.Right * ScreenWidth / FormWidth, this.label1.Margin.Bottom * ScreenHeight / FormHeight);
            ...
            //this.panel1.Width = this.pictureBox1.Width * ScreenWidth / FormWidth;
